...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(Plots.histogram2d)),Any,typeof(histogram2d),Any,Vararg{Any,N} where N})
    ...
    Base.precompile(Tuple{typeof(Plots.gr_draw_minorgrid),Plots.Subplot{Plots.GRBackend},Plots.Axis,Segments{Tuple{Float64,Float64}},Function})
    ...
    Base.precompile(Tuple{typeof(Plots.make_steps),Array{Int64,1},Symbol})
